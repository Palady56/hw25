...
console.log(createDomElement('p', 'This paragraph has been added to the specified container. (p)', container))
console.log(createDomElement('div', 'This paragraph has been added to the specified container. (div)', container))
...
function setUserInfoCookie(key, value) {
  ...
  console.log(`Cookie userInfo установлено с значением: ${encodedValue}`);
}
...
function getUserInfo(key) {
  const value = sessionStorage.getItem(key);
    ...
    console.log(`Получено ${key}: ${value}`);
...
saveUserInfo('firstName', 'Jack');
saveUserInfo('lastName', 'Johnson');
console.log(getUserInfo('username')); // Виведе: JohnDoe
console.log(getUserInfo('firstName')); 
console.log(getUserInfo('lastName')); 
